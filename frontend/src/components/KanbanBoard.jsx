...
function KanbanBoard({ columns, onClose, onAddCard, onDeleteCard, onMoveCard, onAddColumn, onDeleteColumn, onSendToCanvas }) {
        ...
        <div style={{
          ...
          {columns.map((column) => (
            <div
              ...
              onDragEnter={(e) => { e.currentTarget.style.backgroundColor = "#3d3f55"; }}
              onDragLeave={(e) => { e.currentTarget.style.backgroundColor = "#313244"; }}
              style={{
            ...
            >
              ...
              <div style={{
                ...
                <button
                  ...
                  onMouseEnter={(e) => { e.target.style.color = "#f38ba8"; }}
          ...
          {/* Add Column button — sits after the last column */}
          <button
            onClick={onAddColumn}
            style={{
              minWidth: "180px",
